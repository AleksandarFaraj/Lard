 ...
 *   }]);
    ...
    function Browser(window, document, $log, $sniffer) {
        ...
        /**
         * @private
         * Note: this method is used only by scenario runner.js
         * TODO(vojta): prefix this method with $$ ?
         * @param {function()} callback Function that will be called when no outstanding request
         */
        self.notifyWhenNoOutstandingRequests = function (callback) {
            // force browser to execute all pollFns - this is needed so that cookies and other pollers fire
            // at some deterministic time in respect to the test runner.js's actions. Leaving things up to the
                ...
                $rootElement.on('click', function (event) {
                    ...
                    if (absHref && !elm.attr('target') && rewrittenUrl && !event.isDefaultPrevented()) {
                        ...
                        if (rewrittenUrl != $browser.url()) {
                            ...
                            $rootScope.$apply();
                            // hack to work around FF6 bug 684208 when scenario runner.js clicks on links
...
// service.
     ...
     * @example
     ...
     it('should display the greeting in the input box', function() {
       ...
       // If we click the button it will block the test runner.js
 ...
 *     });
    ...
    var ngBindTemplateDirective = ['$interpolate', function ($interpolate) {
        return function (scope, element, attr) {
            // TODO: move this to scenario runner.js
